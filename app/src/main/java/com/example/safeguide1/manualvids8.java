...
public class manualvids8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_manualvids8, container, false);
    ...
    private void playVideo() {
        ...
        String videoPath = "android.resource://" + requireContext().getPackageName() + "/" + R.raw.tour;
